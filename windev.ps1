...
function Get-LatestRelease {
    try {
        $releases = Invoke-RestMethod -Uri 'https://api.github.com/repos/jstok84/winutil/releases'
...
function RedirectToLatestPreRelease {
    ...
    if ($latestRelease) {
        $url = "https://github.com/jstok84/winutil/releases/download/$latestRelease/winutil.ps1"
    } else {
        ...
        $url = "https://github.com/jstok84/winutil/releases/latest/download/winutil.ps1"
    }
